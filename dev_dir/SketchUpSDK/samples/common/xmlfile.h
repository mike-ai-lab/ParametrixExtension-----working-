...
class CXmlFile {
 ...
 private:
  SU_tinyxml2_1_0_11::XMLElement* WriteStartTag(const char* tag);
  void WriteColor(const SUColor& color);

  bool ReadHeader();
  bool ReadColor(const SU_tinyxml2_1_0_11::XMLNode* parent_node, const SUColor& color) const;

  bool ReadLayers(
      const SU_tinyxml2_1_0_11::XMLNode* parent_node, std::vector<XmlLayerInfo>& layer_infos) const;
  bool ReadLayerInfo(const SU_tinyxml2_1_0_11::XMLNode* parent_node, XmlLayerInfo& info) const;
  bool ReadMaterialInfo(
  ...
  bool ReadEdgeInfo(const SU_tinyxml2_1_0_11::XMLNode* parent_node, XmlEdgeInfo& info) const;
  bool ReadFaceInfo(const SU_tinyxml2_1_0_11::XMLNode* parent_node, XmlFaceInfo& info) const;
  bool ReadCurveInfo(const SU_tinyxml2_1_0_11::XMLNode* parent_node, XmlCurveInfo& info) const;
 ...
 private:
  ...
  SU_tinyxml2_1_0_11::XMLDocument* xml_doc_;
  SU_tinyxml2_1_0_11::XMLNode* parent_node_;
