...
class CXmlImporter {
 ...
 private:
  ...
  void CreateDefinitions(const std::vector<XmlComponentDefinitionInfo>& def_infos);
 ...
 private:
  ...
  typedef std::map<
      std::string, std::pair<SUComponentDefinitionRef, const XmlComponentDefinitionInfo*> >
      CompDefMap;
