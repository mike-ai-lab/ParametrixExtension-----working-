...
class CXmlExporterPlugin : public SketchUpModelExporterInterface {
 public:
  ...
  bool ExportSelectionSetOnly() {
    return m_bExportSelectionSet;
  }
  ...
  bool ConvertFromSkp(
      const std::string& input_skp, const std::string& output_xml,
      SketchUpPluginProgressCallback* callback, void* reserved);
  virtual void ShowSummaryDialog();

  // User Preference accessors
  bool ExportMaterials() {
    return m_bExportMaterials;
  }
  void SetExportMaterials(bool bSet) {
    m_bExportMaterials = bSet;
  }
  bool ExportFaces() {
    return m_bExportFaces;
  }
  void SetExportFaces(bool bSet) {
    m_bExportFaces = bSet;
  }
  bool ExportEdges() {
    return m_bExportEdges;
  }
  void SetExportEdges(bool bSet) {
    m_bExportEdges = bSet;
  }
  bool ExportCameras() {
    return m_bExportCameras;
  }
  void SetExportCameras(bool bSet) {
    m_bExportCameras = bSet;
  }
  bool ExportMaterialsByLayer() {
    return m_bExportMaterialsByLayer;
  }
  void SetExportMaterialsByLayer(bool bSet) {
    m_bExportMaterialsByLayer = bSet;
  }
  bool ExportLayers() {
    return m_bExportLayers;
  }
  void SetExportLayers(bool bSet) {
    m_bExportLayers = bSet;
  }
  bool ExportOptions() {
    return m_bExportOptions;
  }
  void SetExportOptions(bool bSet) {
    m_bExportOptions = bSet;
  }
  bool ExportSelectionSet() {
    return m_bExportSelectionSet;
  }
  void SetExportSelectionSet(bool bSet) {
    m_bExportSelectionSet = bSet;
  }
