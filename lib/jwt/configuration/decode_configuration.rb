...
module JWT
  module Configuration
    ...
    class DecodeConfiguration
      ...
      # @return [Array] the list of acceptable algorithms.
      # @!attribute [rw] required_claims
      # @return [Array] the list of required claims.
      attr_accessor :verify_expiration, :verify_not_before, :verify_iss, :verify_iat, :verify_jti, :verify_aud, :verify_sub, :leeway, :algorithms, :required_claims
